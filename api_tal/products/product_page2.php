...
//     $query = "SELECT * FROM products WHERE goods_id = :cat_id ORDER BY product_id  DESC LIMIT :limit OFFSET :offset";
//     $stmt = $con->prepare($query);

//     $stmt->bindValue(':cat_id', $cat_id); // تأكد أن $cat_id معرفة مسبقاً
